...
function addLogos(data, pathHome) {
    ...
    var leftImgText = "<img alt='" + data.logos.bottom_left.href + "' src='/' style='float:left' " + pathHome + "/" + data.logos.bottom_left.src + ">";
    ...
    var rightImgText = "<img alt='" + data.logos.bottom_right.href + "' src='/' style='float:right' " + pathHome + "/" + data.logos.bottom_right.src + ">";
