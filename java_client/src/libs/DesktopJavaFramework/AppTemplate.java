package libs.DesktopJavaFramework;

import libs.DesktopJavaFramework.modules.AppGUIModule;
import libs.DesktopJavaFramework.ui.dialogs.AppDialogsFacade;
import libs.DesktopJavaFramework.components.*;
import javafx.application.Application;
import javafx.stage.Stage;
import libs.PropertiesManager.src.PropertiesManager;
import libs.DesktopJavaFramework.ui.foolproof.ClipboardFoolproofDesign;
import libs.DesktopJavaFramework.ui.foolproof.FileFoolproofDesign;
import libs.DesktopJavaFramework.ui.foolproof.UndoFoolproofDesign;
import libs.DesktopJavaFramework.modules.AppFileModule;
...
import static libs.DesktopJavaFramework.modules.AppLanguageModule.*;
import libs.jTPS.jTPS;
import libs.jTPS.jTPS_Transaction;
import libs.PropertiesManager.src.InvalidXMLFileFormatException;
...
public abstract class AppTemplate extends Application {
     ...
     */
    public static final String PATH_DATA = "." + File.separator + "app_data" + File.separator;
     ...
     */
    public static final String PATH_PROPERTIES = PATH_DATA + "properties" + File.separator;
    
    /**
     * Directory for storing the recent work file, which keeps track
     * of which files were edited most recently.
     */
    public static final String PATH_RECENT = PATH_DATA + "recent" + File.separator;
     ...
     */
    public static final String PATH_WEB = PATH_DATA + "web" + File.separator;
	...
	try {
		...
		buildAppComponents();
                ...
                if (props.isTrue(AppPropertyType.HAS_FILE_TOOLBAR)) {
                    foolproofModule.registerModeSettings(AppPropertyType.APP_FILE_FOOLPROOF_SETTINGS,
                                                        new FileFoolproofDesign(this));
                }
                if (props.isTrue(AppPropertyType.HAS_CLIPBOARD_TOOLBAR)) {
                    foolproofModule.registerModeSettings(AppPropertyType.APP_CLIPBOARD_FOOLPROOF_SETTINGS,
                                                        new ClipboardFoolproofDesign(this));
                }
                if (props.isTrue(AppPropertyType.HAS_UNDO_TOOLBAR)) {
                    foolproofModule.registerModeSettings(AppPropertyType.APP_UNDO_FOOLPROOF_SETTINGS,
                ...
                if (props.isTrue(AppPropertyType.HAS_WELCOME_DIALOG)) {
            ...
            e.printStackTrace();
            AppDialogsFacade.showStackTraceDialog(guiModule.getWindow(), e, AppPropertyType.APP_ERROR_TITLE, AppPropertyType.APP_ERROR_CONTENT);
            System.exit(0);
	}
    }
	...
	try {
	    ...
	    AppDialogsFacade.showMessageDialog(guiModule.getWindow(), AppPropertyType.PROPERTIES_ERROR_TITLE, AppPropertyType.PROPERTIES_ERROR_CONTENT);
	    return false;
	}
    }
