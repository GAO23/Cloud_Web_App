package libs.PropertiesManager.src;
...
public class PropertiesManager {    
    ...
    public static final String SCHEME_FILE_PATH = "./app_data/" + PROPERTIES_SCHEMA_FILE_NAME;
    ...
    private PropertiesManager() {
        ...
        // not langauge dependent so I will just hardcode it
        this.addTimeOptionList();
    ...
    private void addTimeOptionList(){
        ArrayList<String> firstComboOption = new ArrayList<String>();
        ArrayList<String> secondComboOption = new ArrayList<String>();
        double time = 9;
        ...
        for(int i = 0; i<24; i++){
            ...
            firstComboOption.add(helper(time,morning));
            time += 0.5;
            if (time == 12.0){
                morning = false;
            }
        ...
        for(int i = 0; i<24; i++){
            ...
            secondComboOption.add(helper(time,morning));
            time += 0.5;
            if (time == 12.0){
                morning = false;
            }
            ...
            propertyOptionsLists.put("GENERATOR_FIRST_COMBO_OPTION", firstComboOption);
            propertyOptionsLists.put("GENERATOR_SECOND_COMBO_OPTION", secondComboOption);
    }
    
    private String helper(double time, boolean morning){
    ...
    public void loadProperties(String xmlDataFile)
        ...
        xmlDataFile = propertiesDataPath + File.separator + xmlDataFile;

        // GET THE SCHEMA PATH
        String xmlSchemaFile = SCHEME_FILE_PATH;
        // FIRST LOAD THE FILE
